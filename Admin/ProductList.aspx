                ...
                <div class="card-body">
                    ...
                    <div class="table-responsive">
                        <asp:GridView ID="GVDetails" runat="server" DataKeyNames="ID" OnRowDataBound="GVDetails_RowDataBound" CssClass="table table-bordered table-striped" HeaderStyle-BackColor="#2d6be0"
                            ...
                            <Columns>
                                <asp:TemplateField HeaderText="" HeaderStyle-ForeColor="White" ItemStyle-HorizontalAlign="Center" ItemStyle-Width="10px" HeaderStyle-Width="10px">
                                    <ItemTemplate>
                                ...
                                <asp:TemplateField HeaderText="Product Code" HeaderStyle-ForeColor="White"  ItemStyle-HorizontalAlign="Center">
                                    <ItemTemplate>
                                        <asp:Label ID="lblProduct" runat="server" Text='<%#Eval("Productcode")%>'></asp:Label>
                                    </ItemTemplate>
                                </asp:TemplateField>
                                <asp:TemplateField HeaderText="Product Name" HeaderStyle-ForeColor="White"  ItemStyle-HorizontalAlign="Center">
                                    <ItemTemplate>
                                        <asp:Label ID="lblProductname" runat="server" Text='<%#Eval("Productname")%>'></asp:Label>
                                    </ItemTemplate>
                                </asp:TemplateField>

                                <asp:TemplateField HeaderText="Size" HeaderStyle-ForeColor="White"  ItemStyle-HorizontalAlign="Center">
                                    <ItemTemplate>
