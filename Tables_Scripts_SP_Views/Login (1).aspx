        ...
        <div class="login-page">
            ...
            <div class="login-left">
                ...
                <div class="login-left-caption">
                    <h2>Where Laminate<br />Shine With Style</h2>
                        ...
                        <div class="card-block">
                            ...
                            <div id="loginSection">
                                ...
                                <div class="row m-t-20">
                                    <div class="col-md-12">
                                        <asp:Button ID="btnsave"  runat="server" Text="Sign in" ValidationGroup="form1" CssClass="btn btn-light-primary btn-md btn-block waves-effect waves-light text-center m-b-2" />
                                    </div>
                                    <small id="lnkForgotPassword" style="cursor:pointer;">Forget Password</small>
                                </div>
                            </div>
                            ...
                            <div id="forgotSection" class="d-none">
                                ...
                                <div id="fpStep1" class="fp-step active">
                                    ...
                                    <div class="form-group form-primary">
                                        <input type="text" id="fpEmail" class="form-control" placeholder="Your Email Address" autocomplete="off" />
                                        <span class="form-bar"></span>
                                    </div>
                                    <div class="row m-t-20">
                                        <div class="col-md-12">
